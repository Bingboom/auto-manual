...
- Build or quality-gate changes: `python3 build.py check --config config.yaml --model JE-1000F --region US`
- JP review or publish changes: `python3 build.py publish --config config.ja.yaml --model JE-1000F --region JP`
- Diff-report changes: `python3 build.py diff-report --config config.yaml --model JE-1000F --region US`
