...
- `JBP-3600A / EU / en` engineering builds use [`config.bp-eu-en-web.yaml`](../configs/config.bp-eu-en-web.yaml) and the source/acceptance record at [`jbp3600a_eu_en_web_intake_2026-09.md`](../code-as-doc/reviews/jbp3600a_eu_en_web_intake_2026-09.md). For the approved 2026-09-06 Git-only release batch, the published-source-audited fixture plus locked asset hashes is the formal build input: generate queue-free `auto-manual-web-publish/v1` metadata, assemble the frozen `docs/publish/**` snapshot, and do not read or write live Base rows. The target handoff and exact hashes are in [`jbp3600a_eu_en_web_production_readiness_2026-09.md`](../code-as-doc/reviews/jbp3600a_eu_en_web_production_readiness_2026-09.md).
