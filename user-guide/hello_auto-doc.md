...
2. Data layer
 ...
 - against the Feishu message control plan, the repo is already beyond Phase 0: query, Build Draft Package, Start Review, and structured failure replies are live; the current gap being closed is `Phase 4`, where Publish requires explicit confirmation
