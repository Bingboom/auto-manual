...
- keep `symbol_key` stable so renderer alt text and layout metadata still resolve correctly; do not duplicate `symbols.*.alt` rows in `Localized_Copy.csv`
