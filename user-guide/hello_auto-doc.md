...
线上可访问性和实际部署版本。页面反馈块当前关闭（2026-09-16 操作者决定，`feedback_channels: []`，页面零痕迹）；
机制与售后邮箱渠道（`hello@jackery.com`）保留在册，恢复时配回渠道即可。
GitHub Issues 仍为内部/经销商分诊渠道。
