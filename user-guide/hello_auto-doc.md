...
- `JE-2000E / EU` follows the same shape from [`manual_sources/JE-2000E/EU/en/2.0/phase2`](../manual_sources/JE-2000E/EU/en/2.0/phase2). Each fr–uk route binds a two-entry illustration manifest: the App add-device screens (2.1/2.2) and connection result (2.3–2.5), shared panels cut at 12x from the English block's pages 23–24 with quarantined App recipes. The translated control-panel button labels stay live text.
