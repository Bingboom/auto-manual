...
- 相关文件：
  ...
  [tests/test_report-260301.md](/Users/pika/Documents/cms-demos/manual_demo/tests/test_report-260301.md)

10. 文档化补充（供团队协作）

- 新增了 `layout_params` 参数说明和“参数变更记录模板”。
- 相关文件：
  [dev/layout_params_guide.md](/Users/pika/Documents/cms-demos/manual_demo/dev/layout_params_guide.md)
  [dev/layout_params_change_log_template.md](/Users/pika/Documents/cms-demos/manual_demo/dev/layout_params_change_log_template.md)
