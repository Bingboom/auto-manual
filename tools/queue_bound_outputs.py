...
from tools.queue_outputs import (  # noqa: E402
    ...
    resolve_myst_output_path_for_target as _resolve_myst_output_path_for_target_impl,
    ...
    versioned_myst_output_path as _versioned_myst_output_path_impl,
...
def resolve_myst_output_path_for_target(*, config_path: Path, model: str, region: str) -> Path:
    return _resolve_myst_output_path_for_target_impl(
        config_path=config_path,
        model=model,
        region=region,
        repo_root=_repo_root(),
...
def versioned_myst_output_path(myst_output_path: Path, *, version: str, doc_phase: str | None = None) -> Path:
    return _versioned_myst_output_path_impl(
        myst_output_path,
        version=version,
        doc_phase=doc_phase,
        normalize_release_token=normalize_release_token,
...
def stage_publish_assets_to_host_repo(
    *,
    ...
    return _stage_publish_assets_to_host_repo_impl(
        ...
        built_myst_output_path=built_myst_output_path,
        host_config_path=host_config_path,
        model=model,
        region=region,
        version=version,
