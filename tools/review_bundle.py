...
def _write_overrides_readme(overrides_dir: Path) -> None:
    ...
    readme_text = "\n".join(
        [
            ...
            "",
            "Example:",
            "- Default asset: `docs/_static/manual_assets/hte153_jp/overview/front_product.jpg`",
            f"- Review override: `{_repo_relative(overrides_dir / '_static' / 'manual_assets' / 'hte153_jp' / 'overview' / 'front_product.jpg')}`",
            "",
