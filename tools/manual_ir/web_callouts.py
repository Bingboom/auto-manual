...
def decode_callout_payload(html: str, *, source_ref: str) -> dict:
    ...
    spec = validate_web_callout_html(html, source_ref=source_ref)
    return {
...
def load_web_callout_source(
    ...
    payload = decode_callout_payload(html, source_ref=str(source_path))
