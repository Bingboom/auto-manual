#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Thin CLI dispatcher for cloud-doc backport (G0 split).

Keeps the leaf-module import hub as the compatibility re-export surface (the
cloud_doc_backport facade imports from here), pulls the split modules back into
this namespace, and owns only main().
"""
...
from tools.cloud_doc_backport_args import (  # noqa: E402,F401
    _KNOWN_VALUE_LANGS,
    _family_index_from_args,
    _parse_args,
    _value_index_from_args,
)
from tools.cloud_doc_backport_commands import (  # noqa: E402,F401
    _run_apply,
    _run_apply_review,
...
from tools.cloud_doc_backport_orchestration import (  # noqa: E402,F401
    _auto_sibling_rels,
    _backport_pr_branch,
