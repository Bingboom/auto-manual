...
def process_build_queue(
    *,
    ...
    pending_state = load_pending_queue_state(
        ...
        feishu_doc_field=feishu_doc_field,
    ...
    for group in pending_state.pending_groups:
        result = process_queue_record_group(
            ...
            can_write_feishu_doc=pending_state.can_write_feishu_doc,
            ...
            create_feishu_doc_from_markdown=create_feishu_doc_from_markdown,
