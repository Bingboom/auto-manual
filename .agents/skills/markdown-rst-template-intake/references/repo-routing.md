...
- LCD:
  route to `04_lcd_display_placeholder.rst`.
- Operation guide:
...
- `04_lcd_display_placeholder.rst` is a template page with placeholders but no dedicated recipe file in the current repo.
