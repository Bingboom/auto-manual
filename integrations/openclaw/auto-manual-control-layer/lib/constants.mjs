export const COMMAND_DEFINITIONS = [
  {
    ...
    description: "Dispatch the Start Review worker on main for one or more review-init records and force-reseed from the latest template.",
  },
  {
    commandName: "build-draft",
    workflowFile: "feishu-draft-build-queue.yml",
    workflowName: "Feishu Draft Build Queue",
    description: "Dispatch the Build Draft Package worker on main for one or more Document_link records.",
  },
  {
    commandName: "publish",
