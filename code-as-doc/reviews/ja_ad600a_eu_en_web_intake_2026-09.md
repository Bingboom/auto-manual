...
|---|---|---|
| 5 | specifications + dimensions | Native spec table; complete cropped dimension figure |
| 6 | inbox + overview | Nine responsive cards; complete product overview figure |
| 7–8 | safety, compatibility, power state | Native copy, tables, and warning callout |
| 9 | FAQ | Native searchable copy |
| 10 | installation diagram | Complete gray installation frame and legend |
...
| 16 | connection + daily use + FCC | Complete connection art; other content remains native |
| 17 | warranty | Shared warranty cards with one 2-year period |

The approved recipe archives all 88 source pages and exports 16 target-scoped PNGs. A cold asset replay produced 192 artifacts: 88 page archives, 88 previews, and 16 exports. Every export is hash-locked in the recipe, registry, and illustration manifest.
