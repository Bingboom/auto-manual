...
| <a id="rev-39"></a>REV-39 | IR 共享 | — | 公共语义边界发现与冻结（迁移计划 P1）：列清哪些信息属于公共语义、哪些属于输出端，冻结契约后再开发；计划见 [PR #1083](https://github.com/Bingboom/auto-manual/pull/1083)（未合入） | planned | 待指派 / — |
