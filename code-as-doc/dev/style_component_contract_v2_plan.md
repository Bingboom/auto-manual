...
Status: PR 0–5 complete; PR 6 in progress
...
| PR 6 — FCC ComponentSpec | [ ] | [ ] | `refactor/renderers-fcc-component` | pending implementation commit | pending PR | — | three-language PDF/IDML/Web/Word checks | Local implementation and full acceptance are green; Submitted remains unchecked until the implementation commit is pushed and the PR exists. |
