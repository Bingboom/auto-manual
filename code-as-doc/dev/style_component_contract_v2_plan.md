...
Status: PR 0–1 complete; PR 2 in progress
...
| PR 2 — style schema v2 and four-renderer bindings | [x] | [ ] | `feat/style-contract-schema-v2` | `96f3e411` | [#890](https://github.com/Bingboom/auto-manual/pull/890) | — | schema tests, full unit, style-only pin rebind proof | Local: 16/16 contract tests; full unit/Ruff/guardrails/docs links/check green; 31 styles, 9 planned debts; reference rebind changed only style hash; normalized IDML 728/728 entries identical |
