...
- [ ] If safety/spec data behavior changed, are [`Spec_Footnotes.csv`](../../data/phase2/Spec_Footnotes.csv), [`spec_titles.csv`](../../data/phase2/spec_titles.csv), and [`symbols_blocks.csv`](../../data/phase2/symbols_blocks.csv) interactions still correct?
