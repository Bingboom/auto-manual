...
| MA-018 | PR #943（`fix/review-sync-line-merge`，含本登记行）、#940（骨架切片 S4）、#942（JBP-2000B 四幅插图，base 为 #940 分支，需待 #940 合入自动重定基后再合）——**严格按 #943 → #940 → #942 顺序**。#943 必须先合：`main` 上仍是旧的 merge_params 逻辑，在它合入前对 JE-1000F/US 跑 `sync-review` 或以 review 为源的构建会静默销毁审校文案。**不含** #938、#939、#941、#935 与任何其它骨架切片；不含 `docs/_review` 追平提交（那是 #943 合入后的独立数据提交，需逐文件复核）；不越过 F6、workflow、公开 CLI、Base schema 等独立 gate | 「按你建议的顺序走 1、2、3、4」2026-08-22（承接同轮建议：1=合 #943，2=合 #940 → #942） | 三个 PR 全部合入即失效 | 生效 |
