...
- Execution note: Workstream W / Stage 4a has started with K8 slice 1, which centralizes the queue and build-listener command/response boundary while leaving retry, pagination, and snapshot-lock semantics to their separately gated slices.
