...
- Execution note: Stage 4a items 10, 11, 13, and 14 now provide review-only reference-layout scaffolding, explicit failure-isolated finalize job manifests, approved-contract App page ownership, and target-neutral page-role assembly coverage warnings. Item 12 remains gated on the design-Mac two-document ExtendScript run.
