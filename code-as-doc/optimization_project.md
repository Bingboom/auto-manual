...
- Execution note: Stage 4a items 10, 11, and 13 now provide review-only reference-layout scaffolding, explicit failure-isolated finalize job manifests, and approved-contract App page ownership. Item 12 remains gated on the design-Mac two-document ExtendScript run.
