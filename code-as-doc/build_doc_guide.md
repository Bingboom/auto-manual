...
- `python build.py review --config ... --model ... --region ...` runs that full snapshot refresh before seeding `docs/_review`, matching the online Start Review worker's sync-before-review behavior
