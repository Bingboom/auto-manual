...
- set the mirror repo variable `FEISHU_BUILD_QUEUE_PAUSED=true` until the alternate Feishu credentials and table/view bindings are present; `feishu-build-queue.yml` skips its scheduled queue job while this variable is true
