...
For review-preview / Vercel packaging, the manual pages now reuse the same manual HTML/CSS/JS treatment as the local build, including the generated heading sidebar and the top region/language switcher.
