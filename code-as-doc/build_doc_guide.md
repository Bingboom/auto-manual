...
- Intermediate-form marker reference (the eight directives, the inline subset a cell accepts, known defects, triage): [`../user-guide/md_site_guide.md`](../user-guide/md_site_guide.md)
