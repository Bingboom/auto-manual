...
- the control layer is no longer at the old Phase 0 plan baseline; today it is effectively at `Phase 4 / publish confirmation in progress`, because query, Build Draft Package, Start Review, and structured failure replies are already in place
