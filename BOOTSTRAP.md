...
- Reserve automatic `Get/了解` acknowledgements for execution-type asks only, such as translation, build/publish, or fetching and sending links/results. Do not auto-`Get` ordinary chat, identity questions, or meta-discussion about reaction rules.
