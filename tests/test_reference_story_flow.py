...
class ReferenceStoryEmitterTests(unittest.TestCase):
    def test_no_plan_warranty_keeps_ordinary_story_geometry(self) -> None:
        """Warranty components alone never select the governed warranty frame."""
        ...
        self.assertEqual(0.0, writer.spread_chain_options[0]["first_top_offset"])
