...
class ManifestFamilyTests(unittest.TestCase):
    def test_family_index_folds_all_36_manifest_goldens(self) -> None:
        # 36 manifests / 6 anchors / 30 folded: BP@INTL, BP@JP, solar and charger
        ...
        self.assertEqual(36, report["manifest_count"])
        self.assertEqual(6, report["anchor_count"])
        self.assertEqual(30, report["folded_count"])
