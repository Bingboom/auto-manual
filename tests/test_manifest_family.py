...
class ManifestFamilyTests(unittest.TestCase):
    def test_family_index_folds_all_33_manifest_goldens(self) -> None:
        # 33 manifests / 6 anchors / 27 folded: BP@INTL, BP@JP, solar and charger
        ...
        self.assertEqual(33, report["manifest_count"])
        self.assertEqual(6, report["anchor_count"])
        self.assertEqual(27, report["folded_count"])
