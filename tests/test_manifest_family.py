...
class ManifestFamilyTests(unittest.TestCase):
    def test_family_index_folds_all_31_manifest_goldens(self) -> None:
        # 31 manifests / 6 anchors / 25 folded: BP@INTL, BP@JP, solar and charger
        ...
        self.assertEqual(31, report["manifest_count"])
        self.assertEqual(6, report["anchor_count"])
        self.assertEqual(25, report["folded_count"])
