...
class ManifestFamilyTests(unittest.TestCase):
    def test_family_index_folds_all_41_manifest_goldens(self) -> None:
        # 41 manifests / 6 anchors / 35 folded: BP@INTL, BP@JP, solar and charger
        ...
        self.assertEqual(41, report["manifest_count"])
        self.assertEqual(6, report["anchor_count"])
        self.assertEqual(35, report["folded_count"])
