...
class ManifestFamilyTests(unittest.TestCase):
    def test_family_index_folds_all_35_manifest_goldens(self) -> None:
        # 35 manifests / 6 anchors / 29 folded: BP@INTL, BP@JP, solar and charger
        ...
        self.assertEqual(35, report["manifest_count"])
        self.assertEqual(6, report["anchor_count"])
        self.assertEqual(29, report["folded_count"])
