...
class ManifestFamilyTests(unittest.TestCase):
    def test_family_index_folds_all_30_manifest_goldens(self) -> None:
        # 30 manifests / 6 anchors / 24 folded: BP@INTL, BP@JP, solar and charger
        ...
        self.assertEqual(30, report["manifest_count"])
        self.assertEqual(6, report["anchor_count"])
        self.assertEqual(24, report["folded_count"])
