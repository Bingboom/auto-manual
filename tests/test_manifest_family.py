...
class ManifestFamilyTests(unittest.TestCase):
    def test_family_index_folds_all_28_manifest_goldens(self) -> None:
        # 29 manifests / 6 anchors / 23 folded: BP@INTL, BP@JP, solar and charger
        ...
        self.assertEqual(29, report["manifest_count"])
        self.assertEqual(6, report["anchor_count"])
        self.assertEqual(23, report["folded_count"])
