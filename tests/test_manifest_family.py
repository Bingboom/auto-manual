...
class ManifestFamilyTests(unittest.TestCase):
    def test_family_index_folds_all_27_manifest_goldens(self) -> None:
        # 27 manifests / 6 anchors / 21 folded: BP@INTL, BP@JP, solar and charger
        ...
        self.assertEqual(27, report["manifest_count"])
        self.assertEqual(6, report["anchor_count"])
        self.assertEqual(21, report["folded_count"])
