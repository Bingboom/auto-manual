...
% ---- warning lockup image (icon+WARNING as ONE object) ----
\newcommand{\warninglockup}{%
  \includegraphics[
    height=\csname HBwarn_lockup_height\endcsname,
    viewport=79 70 2125 549,
    clip
  ]{warning_lockup.png}%
}
...
% --------------------------------------------------
% WARNING layout - vertical centered + flat
% (Replace the whole \safetywarning command with this)
% --------------------------------------------------
\usepackage{array} % make sure array is available for m{} column

\newcommand{\safetywarning}[1]{%
\begin{safetywarningbox}%
\noindent%
\begin{minipage}[t]{\csname HBwarn_lockup_width\endcsname}%
\vspace{0pt}\warninglockup%
\end{minipage}\hspace{\csname HBwarn_lockup_gap\endcsname}%
\begin{minipage}[t]{\dimexpr\textwidth-\csname HBwarn_lockup_width\endcsname-\csname HBwarn_lockup_gap\endcsname\relax}%
\vspace{0pt}\raggedright%
{\bfseries\fontsize{\csname HBwarn_text_size\endcsname}{\csname HBwarn_text_leading\endcsname}\selectfont\MakeUppercase{#1}}%
\end{minipage}%
