      ...
      <table style="width:100%; border-collapse:collapse; margin:0.75rem 0 0.5rem 0;">
        <tr>
          <td rowspan="6" style="width:24%; border:1px solid #cfcfcf; padding:8px; vertical-align:top; text-align:center;">
            <img src="renderers/latex/assets/op_lcd_mode.png" alt="LCD display mode placeholder." style="max-width:140px; width:100%; height:auto; display:block; margin:0 auto;">
          </td>
...
.. only:: latex
   ...
   .. raw:: latex
      ...
      \begin{HBLcdModeTable}{op_lcd_mode.png}
