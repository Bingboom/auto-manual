...
.. image:: renderers/latex/assets/op_ups_mode.png
...
| En mode UPS, la puissance de crête de sortie de l'appareil atteint 12A avant les coupures de courant. Comme la charge et la décharge simultanées sont activées en mode dérivation, la puissance de sortie réelle est inférieure à la puissance nominale en mode dérivation, mais revient à la puissance nominale lors des coupures.
...
.. list-table::
   ...
   * - **ATTENTION**
     -
       - Ce produit ne prend pas en charge un basculement instantané (0 ms). Ne le connectez pas à des équipements nécessitant une alimentation vec commutation en 0 ms, tels que des serveurs de données ou des stations de travail.
