...
% ---------- Section pill bar (stable, no begin/end env) ----------
\usepackage{titlesec}
\usepackage[most]{tcolorbox}

% "pill" box as a command (NOT an environment) => avoids Missing } errors
\newtcbox{\hbsectionbox}{%
  enhanced,
  on line,
  colback=BrandDark,
  colframe=BrandDark,
...
% Remove section numbering (remove "1 ")
