...
\begin{safetywarningbox}
  \noindent
  \begin{tabular}{@{}m{\csname HBwarn_lockup_width\endcsname}@{\hspace{\csname HBwarn_lockup_gap\endcsname}}m{\dimexpr\textwidth-\csname HBwarn_lockup_width\endcsname-\csname HBwarn_lockup_gap\endcsname\relax}@{}}
...
% lead sentence = same metrics as list, just bold, no bullet
\newcommand{\safetylead}[1]{%
  {\bfseries
   \fontsize{\csname HBtwocol_font_size\endcsname}{\csname HBtwocol_font_leading\endcsname}\selectfont
   #1}\vspace{0.6mm}%
}
