...
.. image:: _static/manual_template/page_eu/12_app_setup_placeholder/slot_01.png
...
After the device is turned on and not connected to the App within 2 hours, it will automatically turn off Wi-Fi and Bluetooth. Now it is required to press and hold the USB power button and the AC power button to turn on Wi-Fi and Bluetooth again.

.. image:: _static/manual_template/page_eu/12_app_setup_placeholder/slot_02.png
...
.. image:: _static/manual_template/page_eu/12_app_setup_placeholder/slot_03.png
...
- Hold the USB power button and the AC power button at the same time until the Wi-Fi and Bluetooth icons on the screen light up.

**4.2 To turn off Wi-Fi and Bluetooth**

Hold the USB power button and the AC power button at the same time until the Wi-Fi and Bluetooth icons on the screen are off.
...
Hold the POWER button and USB power button at the same time for 3 seconds to reset Wi-Fi and Bluetooth to factory settings and reboot the system. The connected App account will be unbound.
