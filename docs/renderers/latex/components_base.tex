...
\providecommand{\HBTipBlock}[2]{%
  ...
  \begin{tcolorbox}[
    ...
    top=0mm,bottom=0mm,
    height=\csname HBcomp_tip_height\endcsname,
    valign=center,
    before skip=1.8mm,
    after skip=0mm,
    overlay={
      \fill[white]
        ...
        ([xshift=\csname HBcomp_tip_label_width\endcsname]frame.north west);
    }
  ]%
    \begin{tabular}{@{}m{\csname HBcomp_tip_label_width\endcsname}
      @{}m{\dimexpr\linewidth-\csname HBcomp_tip_label_width\endcsname\relax}@{}}%
