...
\expandafter\providecommand\csname HBcomp_inbox_card_arc\endcsname{1.6mm}
...
\providecommand{\HBLangTagLine}[2]{%
  ...
  \colorbox{BrandDark}{\makebox[4.6mm][c]{\rule{0pt}{2.9mm}%
    {\color{white}\HBFontHeavy\fontsize{5.6pt}{5.6pt}\selectfont #1}}}%
  \hspace{1.4mm}%
  {\HBFontSemiBold\color{\csname HBtype_body_color\endcsname}%
   \fontsize{7.2pt}{8.0pt}\selectfont #2}%
  \endgroup
  \par
}
