...
\expandafter\providecommand\csname HBcomp_symbol_signal_width\endcsname{30mm}
\expandafter\providecommand\csname HBcomp_symbol_signal_height\endcsname{8.5mm}
...
\providecommand{\HBSymbolSignalRow}[3]{%
  \begin{minipage}[c]{\csname HBcomp_symbol_icon_col_width\endcsname}
    ...
    \HBIfBlankTF{#2}{%
      ...
      \colorbox{BrandDark}{%
        \makebox[\csname HBcomp_symbol_signal_width\endcsname][l]{%
          \rule{0pt}{\csname HBcomp_symbol_signal_height\endcsname}%
          \hspace{1.5mm}%
          \raisebox{-0.35mm}{%
            \begin{tikzpicture}[x=1mm,y=1mm,baseline=(base)]
              \coordinate (base) at (0,1.25);
              \fill[white] (0,0) -- (2.5,4.4) -- (5,0) -- cycle;
              \node[BrandDark,font=\fontsize{3.2pt}{3.2pt}\selectfont\bfseries] at (2.5,1.45) {!};
            \end{tikzpicture}%
          }%
          \hspace{1.1mm}%
          {\color{white}\HBFontHeavy\fontsize{5.2pt}{5.8pt}\selectfont #2}%
        }%
      }%
      \endgroup
    }%
