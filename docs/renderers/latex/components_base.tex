...
\newcommand{\HBLcdModeFirstGroup}[7]{%
  \multirow{6}{*}{%
    \parbox[c]{\csname HBcomp_lcd_mode_image_col_width\endcsname}{%
      \centering
      \HBImageOrPlaceholder
  ...
  &
  \multirow{3}{*}{%
    \parbox[t]{\csname HBcomp_lcd_mode_state_col_width\endcsname}{\HBTypeLcdLabel{#1}}%
  }%
  & \HBTypeLcdLabel{#2} & \HBTypeLcdText{#3}\tabularnewline \cline{3-4}
  & & \HBTypeLcdLabel{#4} & \HBTypeLcdText{#5}\tabularnewline \cline{3-4}
  & & \HBTypeLcdLabel{#6} & \HBTypeLcdText{#7}\tabularnewline \cline{2-4}
}
...
\newcommand{\HBLcdModeSecondGroup}[7]{%
  ...
  & \HBTypeLcdLabel{#2} & \HBTypeLcdText{#3}\tabularnewline \cline{3-4}
  & & \HBTypeLcdLabel{#4} & \HBTypeLcdText{#5}\tabularnewline \cline{3-4}
  & & \HBTypeLcdLabel{#6} & \HBTypeLcdText{#7}\tabularnewline \hline
}
\makeatother
