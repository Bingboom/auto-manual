...
% Subbar capsule text: white heavy at the L2 size (master's full-round
% dark capsules: OPERATING INSTRUCTIONS / USER MAINTENANCE INSTRUCTIONS).
\providecommand{\HBTypeSubbar}[1]{%
  {\color{white}\HBFontHeavy
   \fontsize{\csname HBtype_title_l2_font_size\endcsname}{\csname HBtype_title_l2_font_leading\endcsname}\selectfont
   \HBifupper{\csname HBtype_h1_force_upper\endcsname}{#1}}%
}
