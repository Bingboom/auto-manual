...
Los botones CA1 y CA2 controlan dos pares separados de tomas de corriente CA. Al presionar
cada botón se enciende o apaga su par correspondiente de tomas de corriente CA.
...
.. list-table::
   ...
   * - **PRECAUCIÓN**
     -
       ...
       - Para obtener la potencia máxima de salida, utilice el cable USB-C a USB-C de 5 A (28 V CC/5 A, 140W). 
...
Para desactivar el modo de ahorro de energía, mantenga pulsados simultáneamente el botón CA1 y el |MAIN_POWER_BUTTON_LABEL_LOWER| durante más de 3 segundos. Una vez desactivado el modo de ahorro de energía, el icono dejará de mostrarse en la pantalla LCD y el producto no apagará automáticamente la salida de CA o CC/USB.
