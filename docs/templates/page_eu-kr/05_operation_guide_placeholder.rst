...
| 에너지 절약 모드가 활성화된 경우, AC1/2 출력 또는 DC/USB 출력이 켜져 있지만 제품이 충전 또는 방전 중이 아니면 |ENERGY_SAVING_AUTO_OFF_DURATION| 후 자동으로 전원이 꺼집니다.
   ...
   .. list-table::
      ...
      * - **주의**
        -
          ...
          - |PRODUCT_NAME_JOSA_EUN| IEC/EN/UL 62368-1(또는 기타 동등한 표준)의 6.3, 6.4 및 6.5항을 준수하는 기기 또는 액세서리에만 연결하십시오.
