...
Cuando el modo de ahorro de energía está activado, el producto se apagará automáticamente después de |ENERGY_SAVING_AUTO_OFF_DURATION| si la CA o DC/USB power button está activada, pero el producto no está cargando ni descargando.
