...
2.2 Press the **POWER** button on the device to turn it on. When the Wi-Fi and Bluetooth icons on the device flash, the device has entered network configuration mode. Tap the "**Icon Flashed**" button, and allow the App to connect to nearby devices and use Bluetooth permissions.
