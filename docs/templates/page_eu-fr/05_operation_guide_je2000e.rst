...
| Lorsque le mode d'économie d'énergie est activé, le produit s'éteindra automatiquement après |ENERGY_SAVING_AUTO_OFF_DURATION| si le bouton CA1/2 ou le |DC_USB_POWER_BUTTON_LABEL_LOWER| est activé mais que le produit ne charge ni ne décharge.
...
Les boutons CA1 et CA2 contrôlent deux paires de prises CA séparées. Appuyer sur chaque
bouton active ou désactive sa paire de prises CA correspondante.
...
Pour désactiver le mode d'économie d'énergie, appuyez simultanément sur le bouton CA1 et sur le |MAIN_POWER_BUTTON_LABEL_LOWER| pendant plus de 3 secondes. Une fois le mode d'économie d'énergie désactivé, l'icône ne s'affichera plus sur l'écran LCD et le produit n'éteindra pas automatiquement la sortie CA ou CC/USB.
...
.. list-table::
   ...
   * - Boutons
     - Utilisation
     - Fonction
   * - Bouton POWER principal + Bouton CA1
