...
.. only:: latex
   ...
   - Ne rechargez pas la batterie dans un environnement extrêmement chaud ou froid, et respectez strictement les plages de températures d’utilisation spécifiées du produit :
     - Température de charge : |CHARGING_TEMPERATURE_VALUE_1|
     - Température de décharge : |DISCHARGING_TEMPERATURE_VALUE_1|
   ...
   - NE placez PAS le produit sur le sol ou à une hauteur inférieure à 457 mm lors de son utilisation dans un atelier ou un centre de réparation.
