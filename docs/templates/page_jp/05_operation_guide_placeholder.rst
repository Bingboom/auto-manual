...
LEDライトには、照明モードとSOSモードの2つのモードがあります。いずれのモードでも、LEDライトボタンを長押しすることでLEDライトを消灯できます。

.. image:: asset:operation/led_light
   :alt: LED light operation diagram.
   :width: 360px

| LEDライトボタンを短く押すとLEDライトが点灯し
