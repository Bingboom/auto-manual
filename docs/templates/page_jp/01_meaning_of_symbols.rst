...
.. list-table::
   ...
   * - .. image:: templates/word_template/common_assets/symbols/unplug.png
          :alt: Unplug symbol.
          :width: 40px
     - コンセントから電源プラグを抜く記号
     - .. image:: templates/word_template/common_assets/symbols/mandatory.png
          ...
          :width: 40px
     - 行為を指示する記号
   * - .. image:: templates/word_template/common_assets/symbols/no_wet_hands.png
     ...
     - .. image:: templates/word_template/common_assets/symbols/prohibited.png
          ...
          :width: 40px
     - 行為を禁止する記号
   * - .. image:: templates/word_template/common_assets/symbols/keep_dry.png
          :alt: Keep dry symbol.
          :width: 40px
     - 製品を濡らすことを禁止する記号
     -
...
.. list-table::
   ...
   * - .. image:: templates/word_template/common_assets/symbols/warning_triangle.png
          :alt: Caution icon.
          :width: 40px
     - **格納式ハンドルを使用して|PRODUCT_NAME|を移動するときは、積み重ねたり、上に他の物を置いたりしないでください。落下して怪我をする場合があります。**

使用上のご注意
--------------

|PRODUCT_NAME|は、定格出力1500Wです。通常時で消費電力が1500Wまでの機器に給電ができるため、多くの電化製品や端末に対応可能です。ただし、電気モーターを搭載している製品（掃除機、ポンプ、冷蔵庫、電動丸ノコ、エアコン、洗濯機、電子レンジ、ドライヤーなど）は、起動時に「誘導負荷」が発生し、公称電力の3～7倍の電力が必要になる場合があります。
...
- 本機は-20°C~45°Cの温度範囲でお使いの機器に電力供給が可能となり、本機の蓄電は-20°C~45°Cで行えます。

  - 動作温度が上記範囲外にある場合、本製品に温度異常マークが表示され、動作しない可能性があります。
...
- 本製品の使用、または使用不能から発生する付随的な損害（事業利益損失を含む）、当社が関与しない接続機器との組み合わせによる誤動作などから生じた損害に関して、当社は一切の責任を負いません。
- 本製品は病院仕様のシーパップ（CPAP）、エクモ（ECMO）、ペースメーカなど、身の安全に関わる医療救急機械の電源としての使用、または消費電力の大きい設備、例えば核施設設備、スペースシャトル製造などの使用は推奨されません。上記設備の使用後に発生した火災、機器故障など個人安全を脅かす事故について、当社は責任を負いません。
