...
.. list-table::
   ...
   * - .. image:: _static/manual_assets/hte153_jp/symbols/unplug.png
          :alt: Unplug symbol.
          :width: 40px
     - コンセントから電源プラグを抜く記号
     - .. image:: _static/manual_assets/hte153_jp/symbols/mandatory.png
          ...
          :width: 40px
     - 行為を指示する記号
   * - .. image:: _static/manual_assets/hte153_jp/symbols/no_wet_hands.png
     ...
     - .. image:: _static/manual_assets/hte153_jp/symbols/prohibited.png
          ...
          :width: 40px
     - 行為を禁止する記号
   * - .. image:: _static/manual_assets/hte153_jp/symbols/keep_dry.png
          :alt: Keep dry symbol.
          :width: 40px
     - 製品を濡らすことを禁止する記号
     -
