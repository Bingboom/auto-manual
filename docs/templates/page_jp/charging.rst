...
.. only:: model_je_2000e
   ...
   **注意**
   ...
   - 正常に動作させるため、両側の吸気口と排気口をふさがないようにしてください。放熱のため、吸排気口の周囲には少なくとも約200mm の空間を確保してください。
...
ACコンセントからの充電時、お急ぎの場合には緊急充電モードを使って充電することができます。使用するには「Jackeryアプリ」でこの機能を「有効」または「無効」に設定してください。緊急充電モードでは、バッテリーの残量（SOC）を示す円形のライトの点滅速度が速くなります。
