...
Die AC1- und AC2-Stromtasten steuern zwei getrennte Paare von AC-Ausgängen. Durch Drücken
jeder Taste wird das entsprechende AC-Steckdosenpaar ein- oder ausgeschaltet.
...
.. list-table::
   ...
   * - **VORSICHT**
     -
       ...
       - Verwenden Sie für die maximale Ausgangsleistung das USB-C-auf-USB-C-5 A-Kabel (28 V DC/5 A, 140 W).
...
.. list-table::
   ...
   * - Tasten
     - Bedienung
     - Funktion
   * - Haupt-POWER-Taste + AC1-Einschalttaste
   ...
   * - DC/USB-Einschalttaste + AC1-Einschalttaste
