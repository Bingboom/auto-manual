...
.. list-table::
   ...
   * - 5
     - Plan de charge
     - Personnalise le temps de charge de |PRODUCT_NAME|.
   ...
   * - 22
     ...
     - Lorsque la sortie CA ou CC est activée en appuyant sur |AC_POWER_BUTTON_LABEL_LOWER| ou |DC_USB_POWER_BUTTON_LABEL_LOWER| :
