.. The EU booklet's French warranty page. Only the remedy heading differs from
   11_warranty.rst: the body there already promises replacement only, so this
   file keeps that approved sentence and gives it the heading that matches --
