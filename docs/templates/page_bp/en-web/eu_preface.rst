...
.. list-table::
   ...
   * - **NOTE**
     - This battery pack is compatible with both |BP_COMPATIBLE_HOST_MODELS|. Throughout this manual, "the portable power station" refers to either model unless otherwise specified.
