...
| When Energy Saving Mode is enabled, the product will automatically shut down after |ENERGY_SAVING_AUTO_OFF_DURATION| if the AC 1/AC 2 power button or DC/USB power button is ON, but the product is neither charging nor discharging.
