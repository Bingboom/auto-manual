...
- Hold |DC_USB_POWER_BUTTON_LABEL_LOWER| + AC1 power button at the same time until the Wi-Fi and Bluetooth icons on the screen light up.

**4.2 To turn off Wi-Fi and Bluetooth**

| Hold |DC_USB_POWER_BUTTON_LABEL_LOWER| + AC1 power button at the same time until the Wi-Fi and Bluetooth icons on the screen are off.
