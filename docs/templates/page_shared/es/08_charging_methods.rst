...
| 
Se recomienda usar el panel solar Jackery para cargar el |PRODUCT_NAME|. Asegúrese de que el voltaje en circuito abierto (V\ :sub:`oc`) del panel solar se sitúe dentro del rango de entrada de CC de |PRODUCT_NAME| (|PV_INPUT_RANGE|). Jackery no se hace responsable de pérdidas causadas por el uso de paneles solares de otras marcas.
