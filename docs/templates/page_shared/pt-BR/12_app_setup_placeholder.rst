...
.. list-table::
   ...
   * - **NOTA**
     - Se "**o dispositivo já foi vinculado**" for exibido durante o processo de vinculação, as duas formas a seguir poderão ser usadas para a conexão:
       ...
       - Pressione e segure |MAIN_POWER_BUTTON_LABEL_LOWER| + |DC_USB_POWER_BUTTON_LABEL_LOWER| por 3 segundos para redefinir o Wi-Fi e o Bluetooth do dispositivo e, em seguida, vincule o dispositivo novamente.
...
- Pressione e segure |DC_USB_POWER_BUTTON_LABEL_LOWER| + |AC_POWER_BUTTON_LABEL_LOWER| ao mesmo tempo até que os ícones de Wi-Fi e Bluetooth na tela acendam.

**4.2 Para desativar Wi-Fi e Bluetooth**

Pressione e segure |DC_USB_POWER_BUTTON_LABEL_LOWER| + |AC_POWER_BUTTON_LABEL_LOWER| ao mesmo tempo até que os ícones de Wi-Fi e Bluetooth na tela se apaguem.

**4.3 Para redefinir Wi-Fi e Bluetooth**

Pressione e segure |MAIN_POWER_BUTTON_LABEL_LOWER| + |DC_USB_POWER_BUTTON_LABEL_LOWER| ao mesmo tempo por 3 segundos para redefinir o Wi-Fi e o Bluetooth para as configurações de fábrica. A conta do aplicativo conectada será desvinculada.
