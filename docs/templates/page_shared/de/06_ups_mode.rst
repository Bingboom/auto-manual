...
=========================================
| Schließen Sie das Produkt mit dem AC-Ladekabel an eine Steckdose an und drücken Sie anschließend |AC_POWER_BUTTON_LABEL_LOWER|, um Ihre Geräte gleichzeitig zu versorgen.
