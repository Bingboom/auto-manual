.. only:: model_je_2000e
   ...
   .. only:: region_us
      ...
      .. list-table::
         ...
         * - **VORSICHT**
           - - Stellen Sie sicher, dass alle Produkte ausgeschaltet sind, bevor Sie |PRODUCT_NAME| mit dem Jackery Battery Pack 2000 verbinden.
...
.. list-table::
   ...
   * - **HINWEIS**
     - - Die empfohlene Ladetemperatur für das Produkt liegt bei |CHARGING_TEMPERATURE_VALUE_1|, und die Entladetemperatur liegt bei |DISCHARGING_TEMPERATURE_VALUE_1|.
