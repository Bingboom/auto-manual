...
|PRODUCT_NAME| має два вхідні порти |DC_INPUT_CONNECTOR| і сумісний із сонячними панелями Jackery.

.. image:: asset:charging/solar_direct
   :alt: Заглушка схеми підключення для сонячного заряджання 1.
   :width: 360px

Якщо до одного входу |DC_INPUT_CONNECTOR| потрібно одночасно підключити дві сонячні панелі, зверніться до наведеної нижче схеми заряджання через з'єднувач сонячних панелей (продається окремо, до стандартної комплектації не входить).
...
.. list-table::
   ...
   * - **УВАГА**
     - До одного входу |DC_INPUT_CONNECTOR| можна підключити не більше двох сонячних панелей.
...
.. list-table::
   ...
   * - **УВАГА**
     - Переконайтеся, що вхідна напруга для обох портів DC однакова. Інакше можна пошкодити пристрій. Наприклад:
       ...
       - Використовуйте сонячні панелі Jackery однієї моделі та однакову кількість панелей, якщо підключаєте сонячні панелі до обох входів |DC_INPUT_CONNECTOR|.
