...
.. only:: model_je_2000e
   ...
   .. list-table::
      ...
      * - FC
        - | 1. Перезапустіть акумуляторні блоки та |PRODUCT_NAME| відповідно.
          | 2. Якщо несправність не зникає, від'єднайте акумуляторний блок від |PRODUCT_NAME| і під'єднайте їх знову.
