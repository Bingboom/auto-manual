...
| У разі раптового зникнення мережевого живлення |PRODUCT_NAME| автоматично перемкнеться на накопичену енергію протягом |UPS_TRANSFER_TIME|, щоб ваші прилади продовжували працювати.
