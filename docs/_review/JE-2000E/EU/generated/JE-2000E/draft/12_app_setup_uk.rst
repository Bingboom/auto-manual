...
2.2 Натисніть Головна кнопка POWER на пристрої, щоб увімкнути його; значки Wi-Fi та Bluetooth на пристрої блимають, що означає перехід пристрою в режим налаштування мережі, торкніться кнопки "**Значок блимає**" і дозвольте додатку підключитися до найближчих пристроїв та надати дозвіл Bluetooth.
...
.. list-table::
   ...
   * - **ПРИМІТКА**
     - Якщо під час процесу прив'язування з'являється повідомлення "**пристрій уже прив'язано**", для підключення можна скористатися одним із двох способів:
       ...
       - Натисніть і утримуйте головна кнопка POWER + кнопка POWER DC / USB протягом 3 секунд, щоб скинути Wi-Fi та Bluetooth пристрою, а потім знову прив'яжіть пристрій.
...
- Одночасно натисніть і утримуйте кнопка POWER DC / USB + кнопка POWER AC, доки значки Wi-Fi та Bluetooth на екрані не загоряться.

4.2 Щоб вимкнути Wi-Fi та Bluetooth
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

| Одночасно натисніть і утримуйте кнопка POWER DC / USB + кнопка POWER AC, доки значки Wi-Fi та Bluetooth на екрані не згаснуть.


4.3 Щоб скинути Wi-Fi та Bluetooth
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Одночасно натисніть і утримуйте головна кнопка POWER + кнопка POWER DC / USB протягом 3 секунд, щоб скинути Wi-Fi та Bluetooth до заводських налаштувань. Обліковий запис підключеного додатка буде відв'язано.
