   ...
   .. list-table::
      ...
      * - 4
        - .. image:: .tmp/review-start/phase2/_attachments/lcd_icons/4_Charging_Plan_PBCtblGMaoHz4fx08tRcoXUJnIf.png
             ...
             :width: 42px
        - Charging Plan
        - | Customizes the charging time of the Jackery Explorer 2000 Plus. Suitable for situations with fluctuating electricity prices, it allows for charging plans based on peak and off-peak electricity times, reducing electricity costs.
          | Enable/disable this feature in the Jackery App. The setting is retained when the device is powered off.
      * - 5
...
.. only:: latex
   ...
   .. raw:: latex
      ...
      \HBLcdIconRow{4}{4_Charging_Plan_PBCtblGMaoHz4fx08tRcoXUJnIf.png}{Charging Plan}{Customizes the charging time of the Jackery Explorer 2000 Plus. Suitable for situations with fluctuating electricity prices, it allows for charging plans based on peak and off-peak electricity times, reducing electricity costs. \newline Enable/disable this feature in the Jackery App. The setting is retained when the device is powered off.}
      ...
      \HBLcdIconRow{7}{7_UPS_JMnybDJHdoLbjExEMbGcfAkznQh.png}{UPS}{\textbf{On:} The product is operating in bypass mode. Loads connected to the AC ports consume power from the grid instead of the power station. If the grid suddenly fails, the product automatically switches to its battery power within 10 ms. \newline \textbf{Off:} The product is not in bypass mode. Loads connected to the AC ports are powered by the internal battery of the power station.}
      \HBLcdIconRow{8}{8_AC_Power_Indicator_IqesbVEWTo0ANfxDkoDcLP6jnSc.png}{AC Power Indicator}{The AC output (pure sine wave) is on.}
      \HBLcdIconRow{9}{9_Output_Voltage_and_Frequency_XtL4bA80pogLmOx7VJ3ca5fEnl8.png}{Output Voltage and Frequency}{Displays the output voltage and frequency when the AC output is turned on.}
      \HBLcdIconRow{10}{10_Input_Power_BiBvbNteAoNsHqxoMICc11cjnHc.png}{Input Power}{Displays the input power in watts.}
      \HBLcdIconRow{11}{11_Remaining_Charge_Time_VeBobGZMDoYpBuxLRcFcti9cnlc.png}{Remaining Charge Time}{Displays the remaining charging time.}
      \HBLcdIconRow{12}{12_AC_Wall_Charging_Indicator_OG9ebaP1HoaLvZxbGEAcIXkPnkb.png}{AC Wall Charging Indicator}{The product is charged via the AC Input using grid power.}
      ...
      \HBLcdIconRow{21}{21_Connected_Batteries_JUdEbyBUeo6BHWxDDzBc6X2Hntc.png}{Connected Batteries}{Displays the quantity of battery packs if any are connected.}
      \HBLcdIconRow{22}{22_Energy_Saving_Mode_FdBWbTvwwosJ7TxfeVIc2Flinkh.png}{Energy Saving Mode}{When the AC or DC output is turned on by pressing the AC1/2 or DC/USB power button: \newline \textbf{On:} Energy Saving Mode is enabled. \newline \textbf{Off:} Energy Saving Mode is disabled. \newline The setting is retained when the device is powered off.}
