...
| Cuando el modo de ahorro de energía está activado, el producto se apagará automáticamente después de 12 horas si el botón CA o el botón de energía CC/USB está encendido, pero el producto no está cargando ni descargando.
...
.. list-table::
   ...
   * - **PRECAUCIÓN**
     -
       ...
       - Solo conecte el Jackery HomePower 2000 Plus a dispositivos o accesorios que cumplan con las cláusulas 6.3, 6.4 y 6.5 de IEC/EN/UL 62368-1 (u otros estándares equivalentes).
