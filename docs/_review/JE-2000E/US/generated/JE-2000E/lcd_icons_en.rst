   ...
   .. list-table::
      ...
      * - 4
        - .. image:: .tmp/review-start/phase2/_attachments/lcd_icons/4_Charging_Plan_PBCtblGMaoHz4fx08tRcoXUJnIf.png
             ...
             :width: 42px
        - Charging Plan
        - | Customizes the charging time of the HomePower 2000 Plus. Suitable for situations with fluctuating electricity prices, it allows for charging plans based on peak and off-peak electricity times, reducing electricity costs.
          | Enable/disable this feature in the Jackery App. The setting is retained when the device is powered off.
      * - 5
...
.. only:: latex
   ...
   .. raw:: latex
      ...
      \HBLcdIconRow{4}{4_Charging_Plan_PBCtblGMaoHz4fx08tRcoXUJnIf.png}{Charging Plan}{Customizes the charging time of the HomePower 2000 Plus. Suitable for situations with fluctuating electricity prices, it allows for charging plans based on peak and off-peak electricity times, reducing electricity costs. \newline Enable/disable this feature in the Jackery App. The setting is retained when the device is powered off.}
