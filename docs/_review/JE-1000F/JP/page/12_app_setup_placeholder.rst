...
- メイン電源ボタン + DC/USB出力ボタンを同時に3秒間押すと、Wi-FiとBluetoothが初期化されます。
...
- 上記アイコンが点灯しない場合、ディスプレーにWi-FiとBluetoothのアイコンが点灯するまで、DC/USB出力ボタン + AC出力ボタンを同時長押しします。

4.2 Wi-FiとBluetoothをオフにするには（ディスプレーにWi-FiとBluetoothのアイコンが消える）

DC/USB出力ボタン + AC出力ボタンを同時長押しし、ディスプレーにWi-FiとBluetoothのアイコンが消えるまで押し続けます。

4.3 Wi-FiとBluetoothをリセットするには

- メイン電源ボタン + DC/USB出力ボタンを同時に3秒間押すと、Wi-FiとBluetoothが初期化され、接続されているポータブル電源はバインド解除されます。
