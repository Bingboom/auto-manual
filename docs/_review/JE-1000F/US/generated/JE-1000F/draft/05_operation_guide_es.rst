...
.. only:: latex
   ...
   .. raw:: latex
      ...
      \HBLcdModeSecondGroup{Estable en (durante el estado de carga o descarga)}{Encender}{Presione dos veces el botón POWER cuando el producto esté encendido.}{Apagar}{Presione el botón POWER.}{Apagado automático}{La pantalla LCD se apaga automáticamente después de 2 horas de inactividad.}
      \end{HBLcdModeTable}
