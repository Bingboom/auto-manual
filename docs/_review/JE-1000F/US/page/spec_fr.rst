...
.. raw:: latex
   ...
   \begin{spectable}
   \HBTypeSpecLabel{1 × Entrée CA} & \HBSpecMultilineRowStrut{}\HBTypeSpecValue{Mode de charge: 100-120 V\textasciitilde{} 60 Hz, 15 A max. \newline Mode de dérivation\HBSpecMarkerOne{}: 100-120 V\textasciitilde{} 60 Hz, 12 A max.} \HBSpecTallRowBreak
   \hline
...
.. raw:: latex
   ...
   \begin{spectable}
   \HBTypeSpecLabel{3 × Sortie CA} & \HBTypeSpecValue{120 V\textasciitilde{} 60 Hz, 12,5 A max., 1500 W Nominal par port, 1500 W Total, 3000 W crête} \tabularnewline
   \hline
   \HBTypeSpecLabel{Sortie CA en mode dérivation\HBSpecMarkerOne{}} & \HBTypeSpecValue{120 V\textasciitilde{}, 60 Hz, 12 A max.} \HBSpecTallRowBreak
   \hline
   ...
   \hline
   \HBTypeSpecLabel{1 × Sortie USB-A} & \HBTypeSpecValue{18 W max., 5-6 V⎓3 A, 6-9 V⎓2 A, 9-12 V⎓1,5 A} \tabularnewline
   \hline
   \HBTypeSpecLabel{1 × Port CC 12V} & \HBTypeSpecValue{12 V⎓10 A max.} \tabularnewline
   \end{spectable}
...
.. raw:: latex
   ...
   \begin{spectable}
   \HBTypeSpecLabel{Température de charge} & \HBTypeSpecValue{32 °F à 113 °F / 0 °C à 45 °C} \tabularnewline
   \hline
      ...
      <table class="hb-spec-table">
        <tbody>
          <tr>
            ...
            <td class="hb-spec-value">32 °F à 113 °F / 0 °C à 45 °C</td>
          </tr>
          <tr>
