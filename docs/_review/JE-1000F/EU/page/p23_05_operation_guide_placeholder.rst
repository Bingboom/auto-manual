...
| Lorsque le mode d'économie d'énergie est activé, le produit s'éteindra automatiquement après 12 heures si le bouton power CA ou le bouton d'alimentation DC / USB est activé mais que le produit ne charge ni ne décharge.
...
Pour désactiver le mode d'économie d'énergie, appuyez simultanément sur le bouton power CA et sur le bouton POWER pendant plus de 3 secondes. Une fois le mode d'économie d'énergie désactivé, l'icône ne s'affichera plus sur l'écran LCD et le produit n'éteindra pas automatiquement la sortie CA ou CC/USB.
