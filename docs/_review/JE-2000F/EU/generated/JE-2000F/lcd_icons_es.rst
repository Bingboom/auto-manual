...
.. only:: latex
   ...
   .. raw:: latex
      ...
      \HBLcdIconRow{1}{1_Wi-Fi_WuAbbIls6okb8pxBe5RcObWUnNd.png}{Wi-Fi}{\textbf{Encendido:} Wi-Fi conectado. \newline \textbf{Parpadeo:} listo para conectarse al Wi-Fi. \newline \textbf{Apagado:} Wi-Fi desconectado.}
      \HBLcdIconRow{2}{2_Bluetooth_EaovbGeSmoIldpxVoWrcVankn5d.png}{Bluetooth}{\textbf{Encendido:} Bluetooth conectado. \newline \textbf{Parpadeo:} listo para conectarse al Bluetooth. \newline \textbf{Apagado:} Bluetooth desconectado.}
      \HBLcdIconRow{3}{3_Quiet_Charging_Mode_IRdmbJVhco57yOx8m0pcdgkXnbe.png}{Modo de Carga Silenciosa}{\textbf{Encendido:} el ruido durante la carga se minimiza significativamente, mientras que la potencia de carga se reduce y la velocidad de carga disminuye. \newline \textbf{Apagado:} El modo de carga silenciosa está desactivado. \newline Activar/desactivar esta función en la App Jackery. Cuando el dispositivo se apaga, se retiene la configuración.}
