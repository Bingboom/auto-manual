...
.. list-table::
   ...
   * - **NOTA**
     - Se durante la procedura di associazione viene visualizzato il messaggio "**il dispositivo è già stato associato**", puoi usare i due metodi seguenti per la connessione:
       ...
       - Tieni premuti pulsante POWER principale + pulsante DC / USB per 3 secondi per ripristinare il Wi-Fi e il Bluetooth del dispositivo, quindi associa nuovamente il dispositivo.
