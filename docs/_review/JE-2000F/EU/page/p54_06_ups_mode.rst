...
=========================================
| Schließen Sie das Produkt mit dem AC-Ladekabel an eine Steckdose an und drücken Sie anschließend <text bgcolor="light-yellow">d</text><text bgcolor="light-yellow">er</text> AC-Einschalttaste, um Ihre Geräte gleichzeitig zu versorgen.
