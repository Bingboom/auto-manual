...
.. only:: model_je_2000e
   ...
   .. list-table::
      ...
      * - **УВАГА**
        - - Перед підключенням Jackery Explorer 2000 до Jackery Battery Pack 2000 переконайтеся, що всі вироби вимкнені.
...
.. list-table::
   ...
   * - **ПРИМІТКА**
     - - Рекомендований діапазон температури заряджання для пристрою становить від 0 °C до 45 °C, а діапазон температури розряджання - від -10 °C до 45 °C.
