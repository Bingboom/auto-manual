...
.. only:: latex
   ...
   .. raw:: latex
      ...
      \HBOverviewPair{Pulsante DC / USB}{}{Luce LED}{}
      ...
      \HBOverviewPanel{<text bgcolor="light-yellow">VISTA LATERALE DESTRA</text>}{right_side_ports.png}{%
...
.. only:: not latex
   ...
   .. list-table::
      ...
      * - **Uscita USB-A 18 W**
        ...
        - **Uscita CA**
          ...
          230 V~ 50 Hz, 10 A max., 2200 W nominali totali, 4400 W di picco
   ...
   <text bgcolor="light-yellow">VISTA LATERALE DESTRA</text>
   ---------------------------------------------------------
   ...
   .. list-table::
      ...
      * -
        - **Ingresso DC (2×porte DC8020)**
          ...
          PV: 16-60 V⎓12 A max., fino a 21 A max. / 400 W max. con doppio ingresso
