...
| Cuando el modo de ahorro de energía está activado, el producto se apagará automáticamente después de 12 horas si el botón CA o el botón CC/USB está encendido, pero el producto no está cargando ni descargando.
...
.. list-table::
   ...
   * - **PRECAUCIÓN**
     -
       ...
       - Solo conecte el Jackery Explorer 2000 a dispositivos o accesorios que cumplan con las cláusulas 6.3, 6.4 y 6.5 de IEC/EN/UL 62368-1 (u otros estándares equivalentes).
