...
.. raw:: latex
   ...
   \begin{spectable}
   \noindent\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}m{\csname HBcomp_spec_table_left_ratio\endcsname\linewidth}|>{\raggedright\arraybackslash}X@{}}
   \HBTypeSpecLabel{2 × AC} & \HBTypeSpecValue{230 V\textasciitilde{} 50 Hz, 12.5 A max., 1500 W Rated per port, 1500 W in Total, 3000 W Surge Peak} \\
   \hline
   \HBTypeSpecLabel{AC Output in Bypass Mode} & \HBTypeSpecValue{230 V\textasciitilde{} 50 Hz, 1500 W} \\
   \hline
      ...
      <table class="hb-spec-table">
        <tbody>
          <tr>
            ...
            <td class="hb-spec-value">230 V~ 50 Hz, 12.5 A max., 1500 W Rated per port, 1500 W in Total, 3000 W Surge Peak</td>
          </tr>
          <tr>
            <th scope="row" class="hb-spec-label">AC Output in Bypass Mode</th>
            <td class="hb-spec-value">230 V~ 50 Hz, 1500 W</td>
          </tr>
          <tr>
