...
.. raw:: latex
   ...
   \hline
   \HBTypeSpecLabel{USB-C 30W} & \HBTypeSpecValue{30 W max., 5 V⎓3 A, 9 V⎓3 A, 12 V⎓2.5 A, 15 V⎓2 A, 20 V⎓1.5 A \newline 100 W max., 5 V⎓3 A, 9 V⎓3 A, 12 V⎓3 A, 15 V⎓3 A, 20 V⎓5 A} \\
   \hline
      ...
      <table class="hb-spec-table">
        <tbody>
          ...
          <tr>
            ...
            <td class="hb-spec-value">Car: 11 V-16 V⎓8 A max., Double to 8 A max.<br/>PV: 16 V-60 V⎓12 A, Double to 21 A max. / 400 W max.</td>
          </tr>
        </tbody>
      </table>
   ...
   .. raw:: html
      ...
      <table class="hb-spec-table">
        <tbody>
          ...
          <tr>
            <th scope="row" class="hb-spec-label">USB-C 30W</th>
